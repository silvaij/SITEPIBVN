...
addToClasspath(module.resolveja('../rs/mail-1.4.4.jar'));
...
/**
 * Optionally provide a config module exporting a `mail` property.
 *
 * @param {String} path the path where to require config from
 */
exports.config = function (path) {
    config = require(path).mail;
};
